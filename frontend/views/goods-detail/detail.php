    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="'http://admin.yii2_demo.com/'.<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=Html::img('http://admin.yii2_demo.com/'.$good->logo)?>              <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            foreach ($goods_albums as $k=>$goods_album){?>
                                <li <?=($k==0)?'class="cur"':' '?> >
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?='http://admin.yii2_demo.com/'.$goods_album->path?>',largeimage: '<?='http://admin.yii2_demo.com/'.$goods_album->path?>'}"><?=Html::img('http://admin.yii2_demo.com/'.$goods_album->path)?></a>
                            </li>
                            <?php
                            }
                            ?>
