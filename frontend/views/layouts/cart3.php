...
frontend\assets\Cart3Asset::register($this);
            ...
            <div class="topnav_right fr">
                <ul>
                    ...
                    if(Yii::$app->user->isGuest){
                        ?>
                        <li>您好，欢迎来到京西！[<?=Html::a('登录',['member/login'])?>] [<?=Html::a('免费注册',['member/register'])?>] </li>
                        <?php
                    }else{?>
                        <li><span style="color: red"><?=Yii::$app->user->identity->username?></span>，欢迎来到京西！[<?=Html::a('注销',['member/logout'])?>] </li>
                        <?php
                    }
                    ?>
